...
const publicPlans = [
    {
        ...
        features: ['Até 10 pacientes', 'Agendamento online', 'Prontuário eletrônico', 'Anamnese mista avançada'],
    ...
    },
    {
        ...
        description: 'Ideal para consultórios e clínicas com gestão profissional.',
        features: ['Relatórios financeiros', 'Agenda avançada', 'Prontuário completo', 'Teleconsulta', 'Suporte por e-mail'],
    ...
    },
    {
        ...
        description: 'Para quem precisa de controle completo e indicadores.',
        features: ['Gestão financeira completa', 'Indicadores estratégicos', 'Simulações avançadas', 'Metas e desempenho', 'Suporte por chat'],
        action: 'Testar 15 dias grátis',
        icon: Crown,
        accent: 'indigo'
    },
    {
        ...
        price: '390,00',
        limit: 'Até 20 profissionais',
        description: 'Para clínicas que querem automatizar e tomar decisões melhores com IA.',
    ...
    },
    {
        ...
        features: ['Recursos personalizados', 'Integrações avançadas', 'SLA garantido', 'Onboarding dedicado', 'Suporte dedicado'],
